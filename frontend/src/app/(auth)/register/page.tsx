...
// Matches the backend's own rule (validation/auth.schemas.ts) — checking
// it here only saves a round trip; the server is what actually enforces it.
...
export default function RegisterPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      verificationRequired = await signUp({ email: email.trim(), password, fullName: fullName.trim() });
    } catch (signUpError) {
