      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-gray-100 bg-white p-5 shadow-sm dark:border-white/8 dark:bg-surface">
        ...
        <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
          <label className="block">
            <span className="mb-1 block text-xs font-medium text-gray-500 dark:text-ink-dim">Название</span>
            <input
              type="text"
              value={name}
          ...
          <div>
            <span className="mb-1 block text-xs font-medium text-gray-500 dark:text-ink-dim">Цвет</span>
              ...
              {CALENDAR_COLORS.map((option) => (
                <button
                  ...
                  className={cn(
                    ...
                    color === option && "ring-2 ring-gray-400 ring-offset-2 dark:ring-white/30 dark:ring-offset-surface",
                  )}
                />
              ))}
            </div>
