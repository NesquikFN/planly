  ...
  return (
    <aside className="flex w-full shrink-0 flex-col gap-4 lg:w-72 lg:sticky lg:top-6 lg:self-start">
      <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-white/8 dark:bg-surface">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-ink">Аккаунт</h3>
        <p className="mt-2 text-sm font-medium text-gray-900 dark:text-ink">{profile.displayName}</p>
        <p className="text-xs text-gray-400 dark:text-ink-faint">Free Plan</p>
        <p className="mt-1 truncate text-xs text-gray-400 dark:text-ink-faint">{profile.email}</p>
      ...
      <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-white/8 dark:bg-surface">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-ink">Безопасность</h3>
        <div className="mt-2 space-y-1.5 text-xs text-gray-500 dark:text-ink-faint">
      ...
      <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-white/8 dark:bg-surface">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-ink">Хранилище</h3>
        <p className="mt-1 text-xs text-gray-400 dark:text-ink-faint">Использовано 420 MB из 1 GB</p>
        <div className="mt-2 h-1.5 w-full overflow-hidden rounded-full bg-gray-100 dark:bg-surface-2">
