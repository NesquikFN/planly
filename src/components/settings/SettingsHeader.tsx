...
export function SettingsHeader({ title, description, isDirty, onCancel, onSave }: SettingsHeaderProps) {
  return (
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          onClick={onSave}
          disabled={!isDirty}
          className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-400 dark:disabled:bg-gray-800 dark:disabled:text-gray-600"
        >
          Сохранить
        </button>
      </div>
