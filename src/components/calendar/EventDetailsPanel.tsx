      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className="truncate text-base font-semibold text-gray-900">{entry.title}</h3>
          ...
          {sourceEvent?.description && <p className="mt-2 max-w-xl text-sm text-gray-500">{sourceEvent.description}</p>}
        </div>
