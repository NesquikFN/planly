...
export const calendarButtonSelected = "border border-gray-200 bg-gray-100 text-gray-900";
export const calendarButtonIdle = "border border-transparent";
export const calendarIconButton = `${calendarButtonBase} border border-transparent p-1.5 text-gray-400`;
